    ...
    <div className="container py-5">
      <div className="row">
        ...
        <div className="col-lg-6 col-xm-12">
          ...
          <p>
          I'm currently a Masters student studying Computational Science and Engineering (CSE) under Georgia Tech's Industrial and System Engineering Schools. I'm Pursuing this major to probe into the uncharted territories of machine learning and AI. In addition, I'm actively looking for an organization that would expose me to multiple perspectives as a software engineer.<br/>
