          ...
          <div className="row">
            <div className="col-lg-3 col-md-6 col-sm-6"> 
              <div className="box">
                ...
                <div className="project-img-wrap mb-5" >
                  <img className="project-img" src={ppe} alt="Georgia Tech CSE..." />
                </div>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="box">
                ...
                <h3>PumpedUP</h3>
                <div className="project-img-wrap mb-5" >
                  <img className="project-img" src={pumpedup} alt="Springboard..." />
                </div>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="box">
                ...
                <div className="project-img-wrap mb-5" >
                  <img className="project-img" src={covid} alt="Georgia Tech MSE..." />
                </div>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="box">
                ...
                <h3>FR Prediction</h3>
                <div className="project-img-wrap mb-5" >
                  <img className="project-img" src={fr} alt="NCKU CHE..." />
                </div>
